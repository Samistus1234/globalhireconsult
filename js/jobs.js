  ...
  var featuredListings = [
    {
      ...
      category: 'Physician',
      positions: 1,
      salary_display: 'Discussed at Interview',
      min_experience: 0,
      visa_sponsored: true,
      benefits: ['Accommodation', 'DataFlow', 'Visa', 'Relocation'],
      description: 'Dermatologist opening at a private hospital in Riyadh, Saudi Arabia (1 position). Saudi licence (SCFHS) or Mumaris registration required. Accommodation provided. ELAB handles DataFlow verification, visa, and relocation.',
      requirements: 'Saudi Licence (SCFHS) / Mumaris + MBBS/MD + Specialty/Fellowship Certificate + Intro Video',
    ...
    },
    {
      ...
      visa_sponsored: true,
      benefits: ['Accommodation', 'DataFlow', 'Visa', 'Relocation'],
      description: 'Ophthalmologist opening at a private hospital in Riyadh, Saudi Arabia (1 position). Saudi licence (SCFHS) or Mumaris registration required. Accommodation provided. ELAB handles DataFlow verification, visa, and relocation.',
      requirements: 'Saudi Licence (SCFHS) / Mumaris + MBBS/MD + Specialty/Fellowship Certificate + Intro Video',
