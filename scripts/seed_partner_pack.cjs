...
const PACK = [
  ...
  { sort_order: 3, code: "eapean_membership",   title: "EAPEAN membership certificate",                file: null, status: "pending", attach: false, notes: "Fee paid Sept 2026; certificate awaited from the association." },
